...
const deliveryData = [
  ...
  {
    title: t('Packages out for delivery'),
    value: '5k',
    change: 4.3,
    icon: 'tabler-truck',
    color: 'info',
...
<template>
  <VCard>
    <VCardItem :title="$t('Delivery performance')">
      <VCardSubtitle>
        {{ $t('12% increase in this month') }}
      </VCardSubtitle>
      <template #append>
        <MoreBtn />
      </template>
