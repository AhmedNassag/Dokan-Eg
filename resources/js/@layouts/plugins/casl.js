...
export const canNavigate = to => {
  ...
  // If no route has explicit action/subject, allow navigation (no permission restrictions)
  const hasRestrictions = to.matched.some(route => route.meta?.action && route.meta?.subject)
  if (!hasRestrictions)
    return true
