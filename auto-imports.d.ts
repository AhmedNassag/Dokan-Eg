...
declare global {
  ...
  const useAuthStore: typeof import('./resources/js/stores/auth.js')['useAuthStore']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useAuthStore: UnwrapRef<typeof import('./resources/js/stores/auth.js')['useAuthStore']>
